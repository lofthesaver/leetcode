...
class Solution:
    def minTimeToReach(self, moveTime: List[List[int]]) -> int:
        ...
        # Initialize pq, start with initial point
        pq = [(0, 0)]
        heapq.heapify(pq)
        ...
        while pq:
            ...
            curr_row, curr_col = heapq.heappop(pq)
            ...
            for neighbor_row, neighbor_col in [(curr_row + 1, curr_col), (curr_row - 1, curr_col), (curr_row, curr_col + 1), (curr_row, curr_col - 1)]:
                ...
                if 0 <= neighbor_row < num_rows and 0 <= neighbor_col < num_cols:
                    ...
                    # Calculate cost it takes to go to this neighbor
                    neighbor_cost = max(moveTime[neighbor_row][neighbor_col], min_costs[curr_row][curr_col]) + 1
                    ...
                    if neighbor_cost < min_costs[neighbor_row][neighbor_col]:
                        ...
                        heapq.heappush(pq, (neighbor_row, neighbor_col))
